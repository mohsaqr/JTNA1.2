...
CNABinarySingleOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "CNABinarySingleOptions",
...
CNABinarySingleResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "CNABinarySingleResults",
    ...
    public=list(
        initialize=function(options) {
            super$initialize(
                options=options,
                name="",
                title="Binary Data (Single/Group)",
                refs=list(
                    "JTNA",
                    "TNA",
                    "TNALAK"))
...
CNABinarySingleBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "CNABinarySingleBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = CNABinarySingleResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
CNABinarySingle <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("CNABinarySingle requires jmvcore to be installed (restart may be required)")
    ...
    options <- CNABinarySingleOptions$new(
    ...
    analysis <- CNABinarySingleClass$new(
        options = options,
        data = data)
