...
CNABinaryClusterOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "CNABinaryClusterOptions",
    ...
    public = list(
        initialize = function(
            ...
            buildModel_window = 1,
            buildModel_window_type = "tumbling",
            clustering_k = 2,
            ...
            super$initialize(
                package="CNA",
                name="CNABinaryCluster",
                requiresData=TRUE,
                ...)

            private$..buildModel_variables_onehot <- jmvcore::OptionVariables$new(
            ...
            private$..buildModel_window <- jmvcore::OptionInteger$new(
                ...
                min=1,
                max=100)
            private$..buildModel_window_type <- jmvcore::OptionList$new(
                "buildModel_window_type",
                buildModel_window_type,
                options=list(
                    "tumbling",
                    "sliding"),
            ...
            self$.addOption(private$..buildModel_window_type)
    ...
    active = list(
        ...
        buildModel_window_type = function() private$..buildModel_window_type$value,
...
CNABinaryClusterResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "CNABinaryClusterResults",
...
CNABinaryClusterBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "CNABinaryClusterBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = CNABinaryClusterResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
CNABinaryCluster <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("CNABinaryCluster requires jmvcore to be installed (restart may be required)")
    ...
    options <- CNABinaryClusterOptions$new(
        ...
        buildModel_window_type = buildModel_window_type,
    ...
    analysis <- CNABinaryClusterClass$new(
        options = options,
        data = data)
