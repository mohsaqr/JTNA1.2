...
CNAEventSingleOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "CNAEventSingleOptions",
...
CNAEventSingleResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "CNAEventSingleResults",
...
CNAEventSingleBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "CNAEventSingleBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = CNAEventSingleResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
CNAEventSingle <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("CNAEventSingle requires jmvcore to be installed (restart may be required)")
    ...
    options <- CNAEventSingleOptions$new(
    ...
    analysis <- CNAEventSingleClass$new(
        options = options,
        data = data)
