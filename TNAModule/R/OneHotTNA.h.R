...
OneHotTNAOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "OneHotTNAOptions",
    ...
    public=list(
        initialize=function(options) {
            super$initialize(
                options=options,
                name="",
                title="One-Hot Co-occurrence Network Analysis",
                refs=list(
                    "TNA"))
...
#'   \code{results$cliques_plot} \tab \tab \tab \tab \tab an image \cr
